...
// igObjectList
const avtindex_t Core::igObjectListVirtuals::kVTIndex_getElementType     = 0x18;
...
const avtindex_t Core::igMetaField::kVTIndex_getStringFromMemory         = 0x3E;
const avtindex_t Core::igMetaField::kVTIndex_getTemplateParameterCount   = 0x4B;
const avtindex_t Core::igMetaField::kVTIndex_getTemplateParameter        = 0x4C;


// igHashTable
const avtindex_t Core::igHashTableVirtuals::kVTIndex_keyTraitsInvalid    = 0x18;
const avtindex_t Core::igHashTableVirtuals::kVTIndex_valueTraitsInvalid  = 0x1B;
